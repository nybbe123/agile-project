        ...
        <div className={style["boxesAlign"]}>
          ...
          <div className={style["firstBox"]}>
            ...
            <div className={style["digitalAlign"]}>
              ...
              <div className={style["alignment"]}>
                <p className={style["firstTextAlign"]}>
                  Security is a priority for us at Webly, we make sure to
          ...
          <div className={style["comp1TextAlign"]}>
            ...
            <div className={style["alignment"]}>
              <p className={style["text1"]}>
                ...
                Comme Ca. They can now view customer orders, stock status of
                their products and easily add new products through an admin
                page. Users can also register an account to view their orders.
                The users sensitive information is encrypted.
              </p>
            </div>
          </div>
        </div>
